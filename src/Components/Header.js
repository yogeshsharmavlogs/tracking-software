...
const Header = () => {
  return (
    ...
    <img src="assets/img/logo/logo-light.png" alt="logo" style={{background:"#063970"}}/>
    </a>
    ...
    <li><a className="dropdown-item" href="#">Team Management</a></li>
    <li><a className="dropdown-item" href="#">Leave Management</a></li>
    <li><a className="dropdown-item" href="#">Task Management</a></li>
    <li><a className="dropdown-item" href="#">Performance Calculator</a></li>
    ...
    <li className="nav-item">
        <a className="nav-link" href="/about">Review Us</a>
    </li>
    ...
    href="#" className="theme-btn"><span className="far fa-plus-circle"></span>Purchase Our Software</motion.a>
    </div>
