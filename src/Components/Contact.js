    ...
    <>
        <div class="site-breadcrumb" style={{background: "url(assets/img/breadcrumb/01.jpg)"}}>
            ...
            <li class="active">Contact Us</li>
                ...
                <div class="contact-info-content">
                <h5>Email Us</h5>
                <p><a href="https://live.themewild.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6f060109002f0a170e021f030a410c0002">[email&#160;protected]</a></p>
                </div>
                </div>
                </div>
                <div class="col-md-3">
                ...
                <form method="post" action="https://live.themewild.com/motex/assets/php/contact.php" id="contact-form">
                <div class="row">
                <div class="col-md-6">
