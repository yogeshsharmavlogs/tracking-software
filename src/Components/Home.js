    ...
    <>
        <div className="hero-section">
            ...
            <motion.a
             ...
             href="#" className="theme-btn">About More<i className="fas fa-arrow-right-long"></i></motion.a>
            <motion.a
              whileHover={{
                scale:1.1,
                textShadow: "0px 0px 8px rgb(255,255,255)",
             ...
             href="#" className="theme-btn theme-btn2">Learn More<i className="fas fa-arrow-right-long"></i></motion.a>
            </div>
            </motion.div>
            </div>
            <div className="col-md-12 col-lg-6">
            ...
            <img src="assets/img/slider/hero-1.jpg" alt="" data-animation="fadeInRight" data-delay=".25s"
...
Software Company in India <span>Quality of Service</span> Business Strategy.

</h2>
</div>
<p className="about-text">
Ingenious Hi Tech” is an IT company, working in all areas of web, application, Marketing, Testing and Maintenance. We have been working with alot of companies of USA,
Canada, UK, Australia, UAE and other countries to enhance their business opportunities digitally. We provide SEO consultant services in USA  .
</p>
...
href="/about" className="theme-btn mt-4">Discover More<i className="fas fa-arrow-right-long"></i></motion.a>
</div>
</motion.div>
</div>
</div>
...
<div 
className="counter-area pt-30 pb-30">
<div className="container">
<div className="row">
...
<motion.div
      ...
      whileInView={"show"}
      viewport={{once:false,amount:0.7}} 
className="site-heading wow fadeInDown" data-wow-delay=".25s">
...
<motion.div 
      ...
      whileInView={"show"}
      viewport={{once:false,amount:0.7}} 
className="choose-img wow fadeInUp" data-wow-delay=".25s">
